...
const PRODUCT_CSS = [
  ...
  '@media(max-width:900px){',
    ...
    '.pd-breadcrumb{padding:80px 0 0}',
  '}',
  '@media(max-width:600px){',
    '.pd-name{font-size:1.5rem}',
    '.pd-price{font-size:1.5rem}',
    '.pd-cart-btn{font-size:.72rem;padding:13px 14px}',
    '.pd-wish-btn{width:46px;height:46px}',
    '.pd-tab-btn{padding:12px 14px;font-size:.65rem}',
    '.pd-tab-panel{padding:24px 0}',
    '.pd-reviews-list{gap:16px}',
    '.pd-related-title{font-size:1.2rem}',
  '}',
  '@media(max-width:480px){',
    '.pd-hero{padding:4px 0 40px}',
    '.pd-breadcrumb{padding:76px 0 0}',
    '.pd-main-wrap{border-radius:16px}',
    '.pd-info{padding-top:0}',
    '.pd-actions{flex-wrap:nowrap}',
    '.pd-tabs-section .container{padding:0 12px}',
