...
const PRODUCTS_CSS = [
  ...
  /* Hero banner */
  '.products-hero{background:#0a0502;padding:120px 0 72px;position:relative;overflow:hidden}',
  ...
  '.products-hero::after{content:"";position:absolute;left:0;right:0;bottom:0;height:4px;',
    'background:linear-gradient(90deg,var(--red),var(--gold-light),var(--red));z-index:1}',

  /* Sticky toolbar */
  '.products-toolbar{background:var(--cream);border-bottom:1px solid var(--cream-dark);',
  ...
  '.toolbar-search input{width:100%;padding:9px 14px 9px 38px;',
    ...
    'background:white;color:var(--brown);transition:.2s;outline:none}',
  ...
  '.toolbar-sort select{padding:9px 14px;border:1.5px solid var(--cream-dark);',
    ...
    'letter-spacing:.06em;background:white;color:var(--brown);',
  ...
  /* Category pills row */
  '.cat-pills-wrap{background:var(--cream);border-bottom:1px solid var(--cream-dark);padding:0}',
